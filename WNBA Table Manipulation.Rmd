...
points <- read.csv("C://Users/Brad Hymas/Desktop/point_diff_2019_updated.csv", header = TRUE)
library(tidyverse)
y <- points$point_diff
x <- points %>% dplyr::select(-point_diff) %>% as.matrix()
library(MASS)
ridge.model <- lm.ridge(y~x, lambda = 2000)
model <- lm(y~x)
...
player2019 <- read.csv("C://Users/Brad Hymas/Desktop/Players_2019.csv")
